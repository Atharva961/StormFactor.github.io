...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    else
    {
        ...
        {
            $sql2 = "DELETE FROM `farmer`.`land` WHERE landid = $landid;";
...
<head>
    ...
    <link rel="stylesheet" href="deleteland.css">
    <style>
...
<?php
    ...
    <div class="container">
        <h2 class = "text-center">Delete Land</h2>
        <form action="/MiniProject/deleteland.php" method = "post">
            <div class="mb-3">
                <label for="landid" class="form-label">Land ID of the land which you want to delete</label>
                <input type="text" class="form-control" id="landid" name="landid" aria-describedby="emailHelp">
            </div>
